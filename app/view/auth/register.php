    ...
    <div class="container px-4 mt-5">
        ...
        <form class="row g-3 m-auto col-md-6" method="POST">
            <div class="col-md-6 mb-3 w-100">
                ...
                <?php
                if (!empty($_SESSION['fnameError'])) {
                    echo '<input type="text" class="form-control is-invalid" id="inputFname4" name="fname">';
                    echo '<div class="invalid-feedback">' . $_SESSION['fnameError'] . '</div>';
                } else {
                    echo '<input type="text" class="form-control" id="inputFname4" name="fname" placeholder="Enter First Name">';
                }
                ?>
            </div>
            <div class="col-md-6 mb-3 w-100">
                ...
                <?php
                if (!empty($_SESSION['lnameError'])) {
                    echo '<input type="text" class="form-control is-invalid" id="inputLname4" name="lname">';
                    echo '<div class="invalid-feedback">' . $_SESSION['lnameError'] . '</div>';
                } else {
                    echo '<input type="text" class="form-control" id="inputlname4" name="lname" placeholder="Enter Last Name">';
                }
                ?>
            </div>
            <div class="col-md-6 mb-3 w-100">
            ...
            <div class="col-md-6 w-100">
                ...
                if (!empty($_SESSION['passError'])) {
                    ...
                    echo '<input type="password" class="form-control" id="inputPassword4" name="pass" placeholder="Enter Password">';
                }
                ?>
            </div>
